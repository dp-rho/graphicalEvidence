...
gen_params_G_Wishart <- function() {
  g_mat <- read.csv(file.path(
    package_dir, 'test_params', 'G_mat_q_100_n_200_delta_50_banded_param_1.csv'
  ), header=FALSE)
  scale_mat <- read.csv(file.path(
    package_dir, 'test_params', 'Scale_mat_q_100_n_200_delta_50_banded_param_1.csv'
  ), header=FALSE)
  X_mat <- read.csv(file.path(
    package_dir, 'test_params', 'X_mat_q_100_n_200_delta_50_banded_param_1.csv'
  ), header=FALSE)
  return(list(
...
gen_params_BGL <- function() {
  X_mat <- read.csv(file.path(
    package_dir, 'test_params', 'X_mat_BGL_q_50_n_125_lambda_140.csv'
  ), header=FALSE)
...
gen_params_Wishart <- function() {
  ...
  scale_mat <- read.csv(file.path(
    package_dir, 'test_params', 'Scale_mat_q_50_n_75_alpha_100.csv'
  ), header=FALSE)
